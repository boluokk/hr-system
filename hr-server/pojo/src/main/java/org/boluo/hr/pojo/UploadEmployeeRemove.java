...
@Data
public class UploadEmployeeRemove {
    /**
     * 主键
     */
     ...
     * 调岗前的部门id
     */
    @NotNull(message = "调岗前的部门id不能为空")
    @Min(value = 1, message = "调岗前的部门id不能小于1")
    private Integer beforeDepartmentId;
    /**
     * 调岗前的职位id
     */
    @NotNull(message = "调岗前的职位id不能为空")
    @Min(value = 1, message = "调岗前的职位id不能小于1")
